                ...
                <div class="card-body">
                    <div class="col">
                        <div class="row" style="">
                            ...
                            <div class="col-2"><b style="font-size:13px;">ผู้สั่งซื้อ </b></div>
                            <div class="col"><p style="font-size:12px; margin-top:3px;">สุชาติ</p></div>   
                        </div>
                        <div class="row">
                            <div class="col"><b style="font-size:13px; margin-top:9px;">วันที่ต้องการรับสินค้า</b></div>
                            <div class="col-9"><p style="font-size:12px; margin-top:3px;">05/03/2563</p></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-1 border-dark" 
                ...
                <div class="card-body">
                    <div class="row" style="">
                        ...
                        <div class="col-7"><p style="font-size:12px; margin-top:3px;">ยกเลิก</p></div>  
