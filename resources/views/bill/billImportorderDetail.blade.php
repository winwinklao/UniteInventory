...
<body>
    ...
    <div class="container" style="width:800px;">
        ...
        <div class="row">
            ...
            <b style="text-align:center; margin-top:15px">ใบรายการสินค้านำเข้า</b>
        </div>
        </span>
                ...
                <div class="card-body">
                    <div class="col">
                        <div class="row" style="">
                            ...
                            <div class="col"><p style="font-size:12px; margin-top:3px;">21/01/2020</p></div>   
                            <div class="col-2"><b style="font-size:13px;">เวลารับสินค้า</b></div>
                            <div class="col"><p style="font-size:12px; margin-top:3px;">09.15 น.</p></div>   
                        </div>
                        <div class="row">
                            <div class="col-2"><b style="font-size:13px; margin-top:9px;">วันที่นำเข้าสินค้า</b></div>
                            <div class="col"><p style="font-size:12px; margin-top:3px;">05/03/2020</p></div>
                            <div class="col-2"><b style="font-size:13px; margin-top:9px;">บริษัท</b></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-9"><p style="font-size:12px; margin-top:3px;">05/02/2020</p></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row" style="background-color:">
            ...
            <div class="card border-1 border-dark" 
                ...
                <div class="card-body">
                    <div class="row" style="">
                        <div class="col"><b style="font-size:13px;">สถานะ</b></div>
                        <div class="col-6"><p style="font-size:12px; margin-top:3px;">ส่งตรงเวลา</p></div>  
                        <div class="col-2"><b style="font-size:13px;">ยอดสั่งซื้อรวม</b></div>
                        <div class="col"><p style="font-size:12px; margin-top:3px;">5500 บาท</p></div>  
                    </div>
                    <div class="row" style="">
                        <div class="col"><b style="font-size:13px;">ผู้สั่งสินค้า</b></div>
                        <div class="col-6"><p style="font-size:12px; margin-top:3px;">ขวัญชัย</p></div>  
