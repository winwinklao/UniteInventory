...
<body>
    ...
    <div class="container" style="width:800px;">
        ...
        <div class="row">
            ...
            <b style="text-align:center; margin-top:15px">ใบจัดส่งสินค้า</b>
        </div>
        </span>
        <div class="row" style="margin-top:20px;">
            <div class="card border-1 border-dark" style="border-radius: 15px;">
                <div class="card-body">
                    <div class="col">
                        <div class="row" style="">
                            <div class="col-3"><b style="font-size:13px;">วันที่ต้องการรับสินค้า</b></div>
                            <div class="col-3"><p style="font-size:12px; margin-top:3px;">05/03/2563</p></div> 
                            <div class="col-2"><b style="font-size:13px;">ที่อยู่ในการจัดส่ง</b></div>
                            <div class="col-4"><p style="font-size:12px; margin-top:3px;">57/2 แขวง 1 เขต 2 กทม. 10210</p></div>  
                        </div>
                        <div class="row">
                            <div class="col-3"><b style="font-size:13px; margin-top:9px;">วันที่ได้รับสินค้า</b></div>
                            <div class="col-3"><p style="font-size:12px; margin-top:3px;">05/03/2563</p></div>
                            <div class="col-2"><b style="font-size:13px; margin-top:9px;">เบอร์ติดต่อ</b></div>
                            <div class="col-4"><p style="font-size:12px; margin-top:3px;">091-XXX-XXX</p></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row" style="margin-top:10px;">
            <div class="card border-1 border-dark" style="border-radius: 0px; border-top-left-radius: 15px 15px; border-top-right-radius: 15px 15px;">
                <div class="card-body">
                    <table class="table">
                        <thead>
                            <tr style="font-size:13px; margin-top:3px; text-align:center;">
        ...
        <div class="row" style="background-color:">
            ...
            <div class="card border-1 border-dark" 
                ...
                <div class="card-body">
                    <div class="row" style="">
                        <div class="col-2"><b style="font-size:13px;">สถานะจัดส่ง</b></div>
                        <div class="col-4"><p style="font-size:12px; margin-top:3px;">สมบูรณ์</p></div>  
                        <div class="col-2"><b style="font-size:13px;">ยอดรวม</b></div> 
                    ...
                    <div class="row" style="">
                        ...
                        <div class="col-4"><p style="font-size:12px; margin-top:3px;">สุชาติ ค้าไม</p></div>  
                        <div class="col-2"><b style="font-size:13px;">ผู้นำส่งสินค้า</b></div> 
                        <div class="col"><p style="font-size:12px; margin-top:3px;">Kerry</p></div>   
                    </div>
                </div>
            </div>
        </div>
